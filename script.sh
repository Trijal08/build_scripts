...
repo init --no-repo-verify --git-lfs --depth=1 -u https://github.com/CipherOS/android_manifest.git -b fifteen
echo "====================="
echo "= Repo init success ="
echo "====================="

# Clone local manifests
git clone --depth=1 https://github.com/Trijal08/local_manifests.git -b Cipher_OS-15.0-shusky .repo/local_manifests
echo "================================="
