...
repo init --no-repo-verify --git-lfs --depth=1 -u https://github.com/Project-Mist-OS/manifest -b 17.0
echo "====================="
echo "= Repo init success ="
echo "====================="

# Clone local manifests
git clone --depth=1 https://github.com/Trijal08/local_manifests.git -b Mist_OS-17.0-caimito .repo/local_manifests
echo "================================="
