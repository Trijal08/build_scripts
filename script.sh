...
repo init --no-repo-verify --git-lfs --depth=1 -u https://github.com/TheXPerienceProject/Manifest.git -b xpe-19.0
echo "====================="
echo "= Repo init success ="
echo "====================="

# Clone local manifests
git clone --depth=1 https://github.com/Trijal08/local_manifests.git -b XPerience-15.0-shusky .repo/local_manifests
echo "================================="
...
export BUILD_USERNAME="Matthew Witherell • Flaring with Joy"
